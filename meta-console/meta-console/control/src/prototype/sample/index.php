<?php include("../../src/config/includes.php"); echo Layout::APILayout();
   ...
   <body>
      ...
      <a-scene>
         ...
         <a-assets>
             ...
             <!--<a-asset-item id="shop" src="https://sosal.in/meta-console/control/common_models/final_shop_1.glb"></a-asset-item>-->
             
            <a-asset-item id="Stand" src="https://sosal.in/meta-console/control/common_models/Stand3.glb"></a-asset-item>
            <!--<a-asset-item id="Stand" src="<?php echo $get_shop_data[0]['rack']?>"></a-asset-item>-->
    ...
    <img id="skyTexture" src="https://sosal.in/meta-console/assets/images/back-city.jpg">
    <!--<img id="skyTexture" src="https://sosal.in/meta-console/assets/images/back3.png">-->
