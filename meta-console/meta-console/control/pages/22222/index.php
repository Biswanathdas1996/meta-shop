<?php $table_name='22222_meta_product_table';?><?php include("../../src/config/includes.php"); echo Layout::APILayout();
...
<html>
           ...
           init: function () {
             this.myFunction = async function (i) {
                 ...
                 if (productId == "checkout") {
                   ...
                   await fetch("https://sosal.in/shop/GetAllProduct.php", requestOptions)
   ...
   <body>
      ...
      <!-- --------------------------------cart modal --------------------- -->
      <!-- --------------------------------taleport modal --------------------- -->
      <div style='position: fixed; top: 10px; width:92%; text-align: right; z-index: 1;'>
          ...
          <a href="list.php">
             <button type="button" class="btn btn-info btn-lg" style="margin-right:20px;" >
                <span class="glyphicon glyphicon-tasks"></span>&nbsp;Settings
            </button>
          </a>
      ...
      <a-scene>
         ...
         <a-assets>
           ...
           <?
            ...
            <a-video src="#video3" width="19.3" height="11.1" position="11 5.7 -11.5" rotation="0 0 0"></a-video>
         ...
         <a-entity gltf-model="#Stand" position="10.5 0 0" scale="3 2 2"></a-entity>
