<?php $table_name='ooooo_meta_product_table';?><?php include("../../src/config/includes.php"); echo Layout::APILayout();
   ...
   <body>
      ...
      <a-scene>
         ...
         <a-assets>
             ...
             <!--<a-asset-item id="shop" src="https://sosal.in/meta-console/control/common_models/shop1.glb"></a-asset-item>-->
